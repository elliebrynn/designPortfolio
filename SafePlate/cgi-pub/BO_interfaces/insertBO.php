...
$sql="INSERT INTO restaurant(restaurant_name,phone_number,address_1,address_2,city,state,zip,filename,image) VALUES ('$sanrestname','$sanphonenumber','$sanaddresslineone','$sanaddresslinetwo','$sancity', '$sanstate', '$sanzip','$image_name','$filepath')";
