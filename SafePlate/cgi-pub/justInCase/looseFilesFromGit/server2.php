<?php
	...
	if (isset($_POST['reg_user'])) {
		...
		$unique_email = mysqli_query($unique);
		...
		if (count($errors) == 0) {
			...
			$vlink='http://cgi.soic.indiana.edu/~trdeal/capstone/verify.php';
			...
			header('location: menu_form.html');
	...
	if (isset($_POST['forgot_password'])){
		...
		if (count($errors) == 0) {
			...
			$vlink='http://cgi.soic.indiana.edu/~trdeal/capstone/reset_password.php';
